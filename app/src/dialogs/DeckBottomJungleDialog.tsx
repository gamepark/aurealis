...
import { Dialog, MaterialComponent, PlayMoveButton, useLegalMoves, useRules } from '@gamepark/react-game'
          ...
          {moves.map((move, index) => (
            <div key={index} css={column}>
              <MaterialComponent
                ...
                itemId={rules.material(MaterialType.JungleCard).getItem(isMoveItem(move) ? move.itemIndex : 0)?.id}
                css={card}
              />
